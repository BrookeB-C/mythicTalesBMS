...
public class TapService {
    ...
    public TapService(TapRepository t, KegRepository k, KegPlacementRepository p, KegEventRepository e, UserAccountRepository users) {
        this.taps = t;
        this.kegs = k;
        this.placements = p;
        this.events = e;
    ...
    @Transactional
    public void tapKeg(Long tapId, Long kegId) { tapKeg(tapId, kegId, null); }

    @Transactional
    public void blow(Long tapId) { blow(tapId, null); }

    @Transactional
    public void pour(Long tapId, double ounces) { pour(tapId, ounces, null); }
    ...
    public void tapKeg(Long tapId, Long kegId, Long actorUserId) {
        ...
        if (actorUserId != null) { users.findById(actorUserId).ifPresent(evt::setActor); }
        events.save(evt);
    }
