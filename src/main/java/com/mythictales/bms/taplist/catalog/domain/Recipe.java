...
public class Recipe {
  ...
  public Double getBatchSizeLiters() {
    return batchSizeLiters;
  }

  public void setBatchSizeLiters(Double v) {
    this.batchSizeLiters = v;
  }

  public Integer getBoilTimeMinutes() {
    return boilTimeMinutes;
  }

  public void setBoilTimeMinutes(Integer v) {
    this.boilTimeMinutes = v;
  }
