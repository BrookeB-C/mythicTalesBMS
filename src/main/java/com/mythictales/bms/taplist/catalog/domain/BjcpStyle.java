...
@Table(
    ...
    uniqueConstraints =
        @UniqueConstraint(
            name = "uq_bjcp_code_year",
            columnNames = {"code", "guideline_year"}))
public class BjcpStyle {
  ...
  @Column(name = "guideline_year")
  private Integer guidelineYear; // BJCP guideline year, e.g., 2015, 2021
  ...
  public Integer getGuidelineYear() {
    return guidelineYear;
  }

  public void setGuidelineYear(Integer year) {
    this.guidelineYear = year;
  }
