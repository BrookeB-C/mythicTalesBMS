...
public class StyleImportService {
  ...
  public StyleImportService(BjcpStyleRepository styles) {
    this.styles = styles;
  }
  ...
  public List<Long> importCsv(InputStream csvStream, boolean upsert) throws Exception {
    try (BufferedReader br =
      ...
      while ((line = br.readLine()) != null) {
        ...
        BjcpStyle s = styles.findFirstByCodeAndGuidelineYear(code, year).orElse(null);
  ...
  private static String trim(String[] a, int i) {
  ...
  private static Double dbl(String[] a, int i) {
    return dblVal(i < a.length ? a[i] : null);
  }

  private static Double dblVal(String s) {
    try {
