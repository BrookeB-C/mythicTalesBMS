...
public class RecipeFermentable {
  ...
  public Double getColorLovibond() { return colorLovibond; }
  public void setColorLovibond(Double colorLovibond) { this.colorLovibond = colorLovibond; }
  public Boolean getLateAddition() { return lateAddition; }
  public void setLateAddition(Boolean lateAddition) { this.lateAddition = lateAddition; }
