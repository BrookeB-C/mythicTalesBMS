...
@Entity
@Table(indexes = { @Index(name = "idx_kegevent_placement_time", columnList = "placement_id, atTime") })
public class KegEvent {
    ...
    public KegPlacement getPlacement() { return placement; }
    public void setPlacement(KegPlacement p) { this.placement = p; }

    public KegEventType getType() { return type; }
    public void setType(KegEventType type) { this.type = type; }

    public Double getOunces() { return ounces; }
    public void setOunces(Double o) { this.ounces = o; }
    ...
    public void setAtTime(Instant at) { this.atTime = at; }
}
