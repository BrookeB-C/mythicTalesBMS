...
- Hero KPIs: Kegs available by size, turn-around time, maintenance overdue.
...
- Quick Actions: Approve access, generate report, lock account.
...
- Confirm priority order for domain roll-out (e.g., Taproom & Keg Inventory first?).
